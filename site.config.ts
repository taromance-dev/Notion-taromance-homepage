...
export default siteConfig({
  ...
  rootNotionPageId: '2e28a3da0e154f7290defe37338b42de',
  ...
  name: 'TAROMANCE',
  domain: 'taromance.co.kr',
  author: 'taromance',

  // open graph metadata (optional)
  description: 'TAROMANCE HOMEPAGE',

  // social usernames (optional)
  // twitter: 'transitive_bs',
  github: 'taromance_dev',
  // linkedin: 'fisch2',
  ...
  navigationLinks: [
    {
      title: '카테고리',
      pageId: '2e28a3da0e154f7290defe37338b42de',
    },
    {
      title: '카테고리',
      pageId: '2e28a3da0e154f7290defe37338b42de',
